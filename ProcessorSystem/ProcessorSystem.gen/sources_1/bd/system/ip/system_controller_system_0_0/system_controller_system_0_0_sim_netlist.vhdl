...
entity system_controller_system_0_0_master_controller is
  port (
    ...
    start_transfer_reg_0 : in STD_LOGIC;
...
architecture STRUCTURE of system_controller_system_0_0_master_controller is
  ...
  attribute SOFT_HLUTNM of start_read_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \state[1]_i_1\ : label is "soft_lutpair0";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \state_reg[0]\ : label is "IDLE:001,WAIT:010,WRITE:100,";
  attribute FSM_ENCODED_STATES of \state_reg[1]\ : label is "IDLE:001,WAIT:010,WRITE:100,";
  attribute FSM_ENCODED_STATES of \state_reg[2]\ : label is "IDLE:001,WAIT:010,WRITE:100,";
begin
...
architecture STRUCTURE of system_controller_system_0_0_uart_rx_ctrl is
  ...
  attribute SOFT_HLUTNM of axi_arvalid_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of axi_arvalid_i_5 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \read_data[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \read_data[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \read_data[3]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \read_data[4]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \read_data[5]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \read_data[6]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \read_data[7]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \state[0]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \state[0]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \state[4]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \state[5]_i_3\ : label is "soft_lutpair2";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \state_reg[0]\ : label is "START_READ_STATUS:000010,WAIT_READ_STATUS:000100,READ_STATUS:001000,READ_DATA:100000,IDLE:000001,START_READ_DATA:010000";
  attribute FSM_ENCODED_STATES of \state_reg[1]\ : label is "START_READ_STATUS:000010,WAIT_READ_STATUS:000100,READ_STATUS:001000,READ_DATA:100000,IDLE:000001,START_READ_DATA:010000";
  attribute FSM_ENCODED_STATES of \state_reg[2]\ : label is "START_READ_STATUS:000010,WAIT_READ_STATUS:000100,READ_STATUS:001000,READ_DATA:100000,IDLE:000001,START_READ_DATA:010000";
  attribute FSM_ENCODED_STATES of \state_reg[3]\ : label is "START_READ_STATUS:000010,WAIT_READ_STATUS:000100,READ_STATUS:001000,READ_DATA:100000,IDLE:000001,START_READ_DATA:010000";
  attribute FSM_ENCODED_STATES of \state_reg[4]\ : label is "START_READ_STATUS:000010,WAIT_READ_STATUS:000100,READ_STATUS:001000,READ_DATA:100000,IDLE:000001,START_READ_DATA:010000";
  attribute FSM_ENCODED_STATES of \state_reg[5]\ : label is "START_READ_STATUS:000010,WAIT_READ_STATUS:000100,READ_STATUS:001000,READ_DATA:100000,IDLE:000001,START_READ_DATA:010000";
begin
  SR(0) <= \^sr\(0);
...
architecture STRUCTURE of system_controller_system_0_0_uart_tx_ctrl is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_awaddr[2]_i_3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of axi_awvalid_i_1 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \axi_wdata[0]_i_1\ : label is "soft_lutpair9";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of write_data_ready_i_2 : label is "soft_lutpair8";
begin
...
architecture STRUCTURE of system_controller_system_0_0_controller_system is
  component system_controller_system_0_0_read_controller is
  port (
    clock : in STD_LOGIC;
    resetn : in STD_LOGIC;
  ...
  end component system_controller_system_0_0_read_controller;
...
read_ctrl: component system_controller_system_0_0_read_controller
     port map (
      clock => axi_aclk,
