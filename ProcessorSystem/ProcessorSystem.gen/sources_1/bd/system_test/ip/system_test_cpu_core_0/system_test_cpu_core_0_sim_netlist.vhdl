...
-- Command     : write_vhdl -force -mode funcsim -rename_top system_test_cpu_core_0 -prefix
--               system_test_cpu_core_0_ system_core_0_0_sim_netlist.vhdl
...
entity system_test_cpu_core_0_execute_unit is
  port (
...
end system_test_cpu_core_0_execute_unit;

architecture STRUCTURE of system_test_cpu_core_0_execute_unit is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_test_cpu_core_0_fetch_unit is
  port (
...
end system_test_cpu_core_0_fetch_unit;

architecture STRUCTURE of system_test_cpu_core_0_fetch_unit is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_test_cpu_core_0_read_unit is
  port (
...
end system_test_cpu_core_0_read_unit;

architecture STRUCTURE of system_test_cpu_core_0_read_unit is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_test_cpu_core_0_register_file_unit is
  port (
...
end system_test_cpu_core_0_register_file_unit;

architecture STRUCTURE of system_test_cpu_core_0_register_file_unit is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_test_cpu_core_0_core is
  port (
    address : out STD_LOGIC_VECTOR ( 9 downto 0 );
...
end system_test_cpu_core_0_core;

architecture STRUCTURE of system_test_cpu_core_0_core is
...
begin
  D(0) <= \^d\(0);
  pc(9 downto 0) <= \^pc\(9 downto 0);
execute_stage: entity work.system_test_cpu_core_0_execute_unit
     port map (
...
fetch_stage: entity work.system_test_cpu_core_0_fetch_unit
     port map (
...
read_stage: entity work.system_test_cpu_core_0_read_unit
     port map (
...
register_file: entity work.system_test_cpu_core_0_register_file_unit
     port map (
      D(31 downto 0) => write_data(31 downto 0),
      E(0) => registers,
      clock => clock,
...
entity system_test_cpu_core_0 is
  ...
  attribute NotValidForBitStream of system_test_cpu_core_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_test_cpu_core_0 : entity is "system_core_0_0,core,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_test_cpu_core_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of system_test_cpu_core_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_test_cpu_core_0 : entity is "core,Vivado 2023.1.1";
end system_test_cpu_core_0;

architecture STRUCTURE of system_test_cpu_core_0 is
...
begin
inst: entity work.system_test_cpu_core_0_core
     port map (
      D(0) => read,
      address(9 downto 0) => address(9 downto 0),
      clock => clock,
