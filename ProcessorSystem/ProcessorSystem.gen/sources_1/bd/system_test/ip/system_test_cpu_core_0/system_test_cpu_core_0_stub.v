...
// Command     : write_verilog -force -mode synth_stub -rename_top system_test_cpu_core_0 -prefix
//               system_test_cpu_core_0_ system_core_0_0_stub.v
...
module system_test_cpu_core_0(clock, reset, instruction, pc, read, write, address, 
  data_out, data_in)
