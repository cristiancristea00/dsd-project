...
#
# Script generated by Vivado on Tue Apr 09 21:49:55 +0300 2024
...
# script info
echo -e "system.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../ProcessorSystem.gen/sources_1/bd/system/ipshared/30ef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../ProcessorSystem.gen/sources_1/bd/system/ipshared/30ef" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"../../../../ProcessorSystem.gen/sources_1/bd/system/ipshared/30ef" \
