...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../ProcessorSystem.gen/sources_1/bd/system/ipshared/30ef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../ProcessorSystem.gen/sources_1/bd/system/ipshared/30ef" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"../../../../ProcessorSystem.gen/sources_1/bd/system/ipshared/30ef" \
