...
#
# Script generated by Vivado on Fri Apr 12 15:24:49 EEST 2024
# SW Build 3900603 on Fri Jun 16 19:30:25 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : system_test.sh
...
#
# Usage        : system_test.sh
#                system_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                system_test.sh [-reset_run]
#                system_test.sh [-reset_log]
#                system_test.sh [-help]
#
...
#                script (type 'system_test.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname blk_mem_gen_v8_4_6 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib blk_mem_gen_v8_4_6)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "system_test.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./system_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.system_test xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.system_test -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/cristian/Documents/ACES/DSD/ProcessorSystem/ProcessorSystem.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log system_test_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./system_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: system_test.sh [-help]\n\
Usage: system_test.sh [-step]\n\
Usage: system_test.sh [-lib_map_path]\n\
Usage: system_test.sh [-reset_run]\n\
Usage: system_test.sh [-reset_log]\n\
Usage: system_test.sh [-keep_index]\n\
Usage: system_test.sh [-noclean_files]\n\n\
