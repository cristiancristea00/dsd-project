...
#
# Script generated by Vivado on Sun May 12 12:52:04 +0300 2024
...
simulate()
{
  xsim system_test -key {Behavioral:sim_1:Functional:system_test} -tclbatch cmd.tcl -protoinst "protoinst_files/system_test.protoinst" -log simulate.log
}
