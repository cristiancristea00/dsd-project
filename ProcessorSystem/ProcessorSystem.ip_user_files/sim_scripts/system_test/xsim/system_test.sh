...
#
# Script generated by Vivado on Sat May 25 22:45:34 +0300 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_6 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot system_test xil_defaultlib.system_test xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="W:/Xilinx/Vivado/2023.1/data/xsim"
  fi
