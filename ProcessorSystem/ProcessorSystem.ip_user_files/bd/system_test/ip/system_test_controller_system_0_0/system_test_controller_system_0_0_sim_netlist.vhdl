...
entity system_test_controller_system_0_0_cpu_controller is
  port (
...
end system_test_controller_system_0_0_cpu_controller;

architecture STRUCTURE of system_test_controller_system_0_0_cpu_controller is
...
architecture STRUCTURE of system_test_controller_system_0_0_controller_system is
  ...
  signal write_data_ready : STD_LOGIC;
begin
cpu_ctrl: entity work.system_test_controller_system_0_0_cpu_controller
     port map (
      SR(0) => read_ctrl_n_1,
      axi_aclk => axi_aclk,
      command(1 downto 0) => command(1 downto 0),
