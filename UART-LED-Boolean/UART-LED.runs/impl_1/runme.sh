...
HD_PWD='/home/cristian/Documents/ACES/DSD/UART-LED-Boolean/UART-LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_led_design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_led_design.tcl -notrace
