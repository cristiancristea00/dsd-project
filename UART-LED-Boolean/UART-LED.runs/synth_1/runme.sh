...
HD_PWD='/home/cristian/Documents/ACES/DSD/UART-LED-Boolean/UART-LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_led_design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_led_design.tcl
