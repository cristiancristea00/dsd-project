...
#
# Script generated by Vivado on Mon Mar 11 17:44:42 EET 2024
# SW Build 3900603 on Fri Jun 16 19:30:25 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : uart_led_design.sh
...
#
# Usage        : uart_led_design.sh
#                uart_led_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                uart_led_design.sh [-reset_run]
#                uart_led_design.sh [-reset_log]
#                uart_led_design.sh [-help]
#
...
#                script (type 'uart_led_design.sh -help' for more information).
#
...
# script info
echo -e "uart_led_design.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./uart_led_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../UART-LED.srcs/sources_1/bd/uart_led_design/ipshared/30ef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../UART-LED.srcs/sources_1/bd/uart_led_design/ipshared/30ef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.uart_led_design xil_defaultlib.glbl -o uart_led_design_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./uart_led_design_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/cristian/Documents/ACES/DSD/UART-LED-Boolean/UART-LED.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key uart_led_design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc uart_led_design_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./uart_led_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: uart_led_design.sh [-help]\n\
Usage: uart_led_design.sh [-step]\n\
Usage: uart_led_design.sh [-lib_map_path]\n\
Usage: uart_led_design.sh [-reset_run]\n\
Usage: uart_led_design.sh [-reset_log]\n\
Usage: uart_led_design.sh [-keep_index]\n\
Usage: uart_led_design.sh [-noclean_files]\n\n\
