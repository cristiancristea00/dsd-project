...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../UART-LED.srcs/sources_1/bd/uart_led_design/ipshared/30ef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../UART-LED.srcs/sources_1/bd/uart_led_design/ipshared/30ef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.uart_led_design xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.uart_led_design -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/cristian/Documents/ACES/DSD/UART-LED-Boolean/UART-LED.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log uart_led_design_sc.so .tmp_log xcelium_lib waves.shm c.obj)
