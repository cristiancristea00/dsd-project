...
vlog -work xpm  -sv2k12 "+incdir+../../../../UART-LED.srcs/sources_1/bd/uart_led_design/ipshared/30ef" -l xpm -l xil_defaultlib \
...
vlog -work xil_defaultlib  -v2k5 "+incdir+../../../../UART-LED.srcs/sources_1/bd/uart_led_design/ipshared/30ef" -l xpm -l xil_defaultlib \
